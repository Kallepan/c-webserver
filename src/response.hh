...
class Response{
    ...
    public:
    Response() {
        std::cout << "Response object created\n";
    }
    ~Response() {
        std::cout << "Response object destroyed\n";
    }
    ...
    void setData(int status_code, std::string status_message, std::string content_type, std::string content) {
